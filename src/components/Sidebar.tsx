...
export default function Sidebar({ isMobileModal = false, onClose }: SidebarProps) {
  return (
    <div
      style={{
        ...
        gap: '20px',
        position: 'relative',
        overflow: isMobileModal ? 'auto' : 'hidden',
        maxHeight: isMobileModal ? '85vh' : undefined,
      }}
      className={isMobileModal ? 'w-full shadow-2xl' : ''}
    >
      {/* Mobile Modal Header / Handle */}
      {isMobileModal && (
        <div className="flex flex-col gap-2 pb-2 border-b border-[rgb(43,43,44)]">
          {/* Pull bar indicator */}
          <div className="w-12 h-1 bg-gray-600 rounded-full mx-auto mb-1" />
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-full bg-[rgb(43,43,44)] hover:bg-[rgb(55,55,60)] flex items-center justify-center text-gray-300 hover:text-white transition-colors cursor-pointer"
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <div
          style={{
            width: isMobileModal ? '150px' : '100%',
            height: isMobileModal ? '150px' : '260px',
            borderRadius: '16px',
        ...
        <h1
          style={{
            ...
            fontSize: isMobileModal ? '22px' : '24px',
            fontWeight: 600,
            letterSpacing: '0em',
            lineHeight: '1.3em',
